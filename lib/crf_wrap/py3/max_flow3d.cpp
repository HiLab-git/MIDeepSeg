...
static struct PyModuleDef cMaxFlow3d =
{
    PyModuleDef_HEAD_INIT,
    "max_flow3d", /* name of module */
    "",          /* module documentation, may be NULL */
    -1,          /* size of per-interpreter state of the module, or -1 if the module keeps state in gobal variables. */
    Methods
};
...
PyMODINIT_FUNC PyInit_max_flow3d(void) {
    import_array();
    return PyModule_Create(&cMaxFlow3d);
}
